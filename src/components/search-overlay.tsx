...
export function SearchOverlay({ open, onClose, bookData, comicData }: SearchOverlayProps) {
  ...
  // Pre-compute searchable strings to avoid running .toLowerCase() on title and author for every keystroke.
  // We use a parallel array to prevent redundant object allocations and a null byte separator to prevent cross-boundary matches.
