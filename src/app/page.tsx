...
export default function Home() {
  ...
  const processedItems = useMemo(() => {
    ...
    // ⚡ Bolt: Use Intl.Collator for case-insensitive sorting instead of repeated .toLowerCase() calls
    // Why: Avoids O(N log N) string allocations and reduces GC pressure during sorting
