...
function EntryPage({
  ...
  // Pre-compute the nameMap for all LinkedText instances in this entry
  ...
  return (
    <div className="mx-auto w-full max-w-[900px] px-4 py-6 sm:px-6">
      ...
      <p className="mb-6 text-sm leading-relaxed text-white/60">
        <LinkedText text={entry.shortDescription} nameMap={nameMap} onNavigate={onNavigate} />
      </p>
          ...
          {entry.description && (
            <ArticleSection title="Overview">
              <p className="text-sm leading-relaxed text-white/55 whitespace-pre-wrap">
                <LinkedText text={entry.description} nameMap={nameMap} onNavigate={onNavigate} />
              </p>
            </ArticleSection>
          )}
                ...
                {items.map((item, i) => (
                  <div key={i} className="flex gap-3 rounded-lg bg-[var(--bg-surface)] px-3 py-2">
                    ...
                    <p className="flex-1 text-xs leading-relaxed text-white/55">
                      <LinkedText text={item.content} nameMap={nameMap} onNavigate={onNavigate} />
